  ...
  return (
    <View style={styles.emptyState} testID={testID}>
      ...
      <View style={styles.emptyTextStack}>
        <Text style={styles.emptyTitle}>{t("schedules.empty.noActiveTitle")}</Text>
        <Text style={styles.emptyDescription}>{t("schedules.empty.noActiveDescription")}</Text>
        <ExternalLink href="https://paseo.sh/docs/schedules" label={t("schedules.empty.seeDocs")} />
      </View>
  ...
  return (
    <View style={styles.filterEmpty}>
      <View style={styles.endedEmptyState}>
        <CalendarClock size={styles.emptyIcon.width} color={styles.emptyIcon.color} />
        <Text style={styles.emptyTitle}>{t("schedules.empty.noEndedTitle")}</Text>
      </View>
    </View>
  );
}
