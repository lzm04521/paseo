  ...
  settings: {
    ...
    appearance: {
      ...
      sidePanel: {
        ...
        autoOpen: {
          title: "ワークスペースを開いたときにサイドパネルを開く",
          description:
            "サイドパネルが表示されていなければ自動的に表示し、上で選んだデフォルトパネルを適用します（デスクトップレイアウトのみ）",
        },
        fileOpen: {
          title: "ファイルを開く場所",
    ...
    host: {
      ...
      terminalProfiles: {
        ...
        powershellPathHint: "内蔵の PowerShell を開くアクションで優先するパス。空欄なら PowerShell 7、次に Windows PowerShell を自動選択します。",
