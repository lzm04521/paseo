...
export const ja: TranslationResources = {
  ...
  schedules: {
    ...
    empty: {
      noActiveTitle: "アクティブなスケジュールはありません",
      noActiveDescription: "スケジュールは一定の周期でエージェントを実行します。",
      noEndedTitle: "終了したスケジュールはありません",
      seeDocs: "ドキュメントを見る",
    },
    errors: {
      unableToLoad: "スケジュールを読み込めませんでした",
      hostLoadFailed: "{{serverName}}: スケジュールを読み込めませんでした",
      cronRequired: "このスケジュールを作成する前に cron 周期を選択してください",
    },
    actions: {
      new: "新規スケジュール",
      retry: "再試行",
    ...
    accessibility: {
      editScheduleTitle: "スケジュールを編集 {{title}}",
      editHeartbeatTitle: "ハートビートを編集 {{title}}",
      scheduleActions: "スケジュールの操作",
      heartbeatActions: "ハートビートの操作",
    },
    deleteConfirm: {
      scheduleTitle: "スケジュールを削除",
      heartbeatTitle: "ハートビートを削除",
      message: "「{{title}}」を削除しますか？この操作は元に戻せません。",
    },
    cadence: {
      label: "周期",
      select: "周期を選択",
      noneFound: "周期が見つかりません",
      cronA11y: "Cron 式",
    },
    form: {
      newTitle: "新規スケジュール",
      editScheduleTitle: "スケジュールを編集",
      editHeartbeatTitle: "ハートビートを編集",
      agentUnavailable: "エージェントは利用できません",
      ...
      fields: {
        ...
        model: "モデル",
        thinking: "Thinking",
        selectThinking: "Thinking を選択",
        noThinking: "Thinking オプションが見つかりません",
        thinkingTitle: "Thinking を選択",
        mode: "モード",
        modeDefault: "デフォルトモード",
        noModes: "モードが見つかりません",
        noModesForModel: "このモデルには利用可能なモードがありません。",
        modeTitle: "モードを選択",
        archiveOnFinish: "終了時にアーカイブ",
        archiveOnFinishA11y: "終了時にアーカイブ",
        isolationLabel: "分離",
        isolationLocal: "ローカル",
        isolationWorktree: "Worktree",
        isolationSelect: "分離を選択",
        isolationNone: "分離オプションが見つかりません",
        isolationTitle: "分離",
      },
    },
  },
  ...
  settings: {
    ...
    host: {
      ...
      terminalProfiles: {
        ...
        powershellPathTitle: "PowerShell パス",
        powershellPathHint:
          "内蔵の PowerShell を開くアクションで優先するパス。空欄なら PowerShell 7、次に Windows PowerShell を自動選択します。",
        powershellPathPlaceholder: "例: C:\\Program Files\\PowerShell\\7\\pwsh.exe",
      ...
      daemon: {
        ...
        idleAutoRestart: {
          ...
          idleFor: "アイドル {{duration}}",
          settings: "設定",
          sheetTitle: "アイドル時自動再起動",
          uptimeLabel: "稼働時間（分）",
          uptimeHint: "デーモンがこの時間稼働したら再起動します（1-10080）",
          idleLabel: "実行中タスクがない時間（分）",
          idleHint: "かつ、この時間アイドルが続いたら再起動します（1-1440）",
          invalidInteger: "整数を入力してください",
          invalidRange: "{{min}} から {{max}} までの値を入力してください",
          save: "保存",
          cancel: "キャンセル",
          errorTitle: "アイドル時自動再起動を更新できません",
        },
        remove: {
          title: "ホストを削除",
    ...
    providers: {
      ...
      addCustom: {
        button: "Claude プロバイダーを手動追加",
        title: "Claude プロバイダーを追加",
        providerId: "プロバイダー ID",
        providerIdPlaceholder: "my-relay",
        providerIdInvalid: "ID は小文字で始まり、小文字・数字・ハイフンのみ使用できます",
        providerIdExists: "この ID は既存のプロバイダーで使用されています",
        label: "表示名",
        labelPlaceholder: "My Relay",
        extendsLabel: "ベースプロバイダー",
        extendsValue: "claude",
        baseUrl: "API エンドポイント（ANTHROPIC_BASE_URL）",
        baseUrlPlaceholder: "https://example.com（空欄で公式 API）",
        authToken: "ANTHROPIC_AUTH_TOKEN",
        apiKey: "ANTHROPIC_API_KEY",
        fetchModels: "モデルを動的に取得（/v1/models）",
        defaultModel: "デフォルトモデル（任意）",
        defaultModelPlaceholder: "例: claude-opus-4-6（空欄なら一覧の最初）",
        save: "追加",
        saving: "追加中…",
      },
      connection: {
