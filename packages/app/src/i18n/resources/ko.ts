  ...
  settings: {
    ...
    host: {
      ...
      terminalProfiles: {
        ...
        powershellPathTitle: "PowerShell 경로",
        powershellPathHint:
          "내장 PowerShell 열기 동작이 우선 사용할 경로입니다. 비워 두면 PowerShell 7, 그다음 Windows PowerShell을 자동 선택합니다.",
        powershellPathPlaceholder: "예: C:\\Program Files\\PowerShell\\7\\pwsh.exe",
        powershellPathSave: "저장",
        editProfile: "프로필 편집",
      ...
      daemon: {
        ...
        idleAutoRestart: {
          ...
          uptimeLabel: "실행 시간(분)",
          uptimeHint: "데몬이 이 시간만큼 실행되면 재시작합니다(1-10080)",
          idleLabel: "실행 중 작업 없이 경과한 시간(분)",
          idleHint: "그리고 이 시간만큼 유휴 상태가 지속되면 재시작합니다(1-1440)",
          invalidInteger: "정수를 입력하세요",
          invalidRange: "{{min}}에서 {{max}} 사이의 값을 입력하세요",
          save: "저장",
          cancel: "취소",
          errorTitle: "유휴 시 자동 재시작을 업데이트할 수 없음",
        },
        remove: {
          title: "호스트 제거",
    ...
    providers: {
      ...
      addCustom: {
        button: "Claude 공급자 수동 추가",
        title: "Claude 공급자 추가",
        providerId: "공급자 ID",
        providerIdPlaceholder: "my-relay",
        providerIdInvalid: "ID는 소문자로 시작하고 소문자, 숫자, 하이픈만 포함해야 합니다",
        providerIdExists: "이 ID는 기존 공급자가 이미 사용 중입니다",
        label: "표시 이름",
        labelPlaceholder: "My Relay",
        extendsLabel: "기본 공급자",
        extendsValue: "claude",
        baseUrl: "API 엔드포인트 (ANTHROPIC_BASE_URL)",
        baseUrlPlaceholder: "https://example.com (비움 = 공식 API)",
        authToken: "ANTHROPIC_AUTH_TOKEN",
        apiKey: "ANTHROPIC_API_KEY",
        fetchModels: "모델 동적으로 가져오기 (/v1/models)",
        defaultModel: "기본 모델(선택)",
        defaultModelPlaceholder: "예: claude-opus-4-6 (비워 두면 목록의 첫 번째 모델)",
        save: "추가",
        saving: "추가 중…",
      },
      connection: {
        ...
        fetchModels: "모델 동적으로 가져오기 (/v1/models)",
        defaultModel: "기본 모델",
        defaultModelUnset: "설정 안 함(목록의 첫 번째 모델)",
        save: "저장",
        saving: "저장 중…",
      },
      statuses: {
