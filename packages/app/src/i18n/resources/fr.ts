...
export const fr: TranslationResources = {
  ...
  schedules: {
    ...
    empty: {
      noActiveTitle: "Aucune planification active",
      noActiveDescription: "Les planifications exécutent des agents à cadence régulière.",
      noEndedTitle: "Aucune planification terminée",
      seeDocs: "Voir la doc",
    },
    errors: {
      unableToLoad: "Impossible de charger les planifications",
      hostLoadFailed: "{{serverName}} : Impossible de charger les planifications",
      cronRequired: "Choisissez une cadence cron avant de créer cette planification",
    },
    actions: {
      ...
      deleteHeartbeat: "Supprimer le heartbeat",
    },
    pending: {
    ...
    accessibility: {
      editScheduleTitle: "Modifier la planification {{title}}",
      editHeartbeatTitle: "Modifier le heartbeat {{title}}",
      scheduleActions: "Actions de planification",
      heartbeatActions: "Actions du heartbeat",
    },
    deleteConfirm: {
      scheduleTitle: "Supprimer la planification",
      heartbeatTitle: "Supprimer le heartbeat",
      message: "Supprimer « {{title}} » ? Cette action est irréversible.",
    },
    cadence: {
      label: "Cadence",
      select: "Sélectionner une cadence",
      noneFound: "Aucune cadence trouvée",
      cronA11y: "Expression cron",
    },
    form: {
      newTitle: "Nouvelle planification",
      editScheduleTitle: "Modifier la planification",
      editHeartbeatTitle: "Modifier le heartbeat",
      ...
      fields: {
        ...
        model: "Modèle",
        thinking: "Thinking",
        selectThinking: "Sélectionner le thinking",
        noThinking: "Aucune option de thinking trouvée",
        thinkingTitle: "Sélectionner le thinking",
        mode: "Mode",
        modeDefault: "Mode par défaut",
        noModes: "Aucun mode trouvé",
        noModesForModel: "Aucun mode disponible pour ce modèle.",
        modeTitle: "Sélectionner un mode",
        archiveOnFinish: "Archiver en fin d'exécution",
        archiveOnFinishA11y: "Archiver en fin d'exécution",
        isolationLabel: "Isolation",
        isolationLocal: "Local",
        isolationWorktree: "Worktree",
        isolationSelect: "Sélectionner l'isolation",
        isolationNone: "Aucune option d'isolation trouvée",
  ...
  workspace: {
    ...
    fileActions: {
      ...
      openInVSCodeFailed: "Impossible d'ouvrir VS Code",
  ...
  settings: {
    ...
    host: {
      ...
      terminalProfiles: {
        ...
        powershellPathTitle: "Chemin de PowerShell",
        powershellPathHint:
          "Chemin privilégié pour l'action intégrée Ouvrir PowerShell. Vide : PowerShell 7 puis Windows PowerShell sont choisis automatiquement.",
        powershellPathPlaceholder: "ex. C:\\Program Files\\PowerShell\\7\\pwsh.exe",
        powershellPathSave: "Enregistrer",
      ...
      daemon: {
        ...
        idleAutoRestart: {
          ...
          idleFor: "inactif depuis {{duration}}",
          settings: "Paramètres",
          sheetTitle: "Redémarrage auto en cas d'inactivité",
          uptimeLabel: "Minutes de fonctionnement",
          uptimeHint: "Redémarrer une fois que le daemon a fonctionné aussi longtemps (1-10080)",
          idleLabel: "Minutes sans tâches en cours",
          idleHint: "Et est resté inactif aussi longtemps (1-1440)",
          invalidInteger: "Saisissez un nombre entier",
          invalidRange: "Saisissez une valeur entre {{min}} et {{max}}",
          save: "Enregistrer",
          cancel: "Annuler",
          errorTitle: "Impossible de mettre à jour le redémarrage auto en cas d'inactivité",
        },
        remove: {
    ...
    providers: {
      ...
      addCustom: {
        button: "Ajouter un fournisseur Claude manuellement",
        title: "Ajouter un fournisseur Claude",
        providerId: "ID du fournisseur",
        providerIdPlaceholder: "my-relay",
        providerIdInvalid:
          "L’identifiant doit commencer par une minuscule et ne contenir que des minuscules, chiffres et tirets",
        providerIdExists: "Cet identifiant est déjà utilisé par un fournisseur existant",
        label: "Nom affiché",
        labelPlaceholder: "My Relay",
        extendsLabel: "Fournisseur de base",
        extendsValue: "claude",
        baseUrl: "Point de terminaison (ANTHROPIC_BASE_URL)",
        baseUrlPlaceholder: "https://example.com (vide = API officielle)",
        authToken: "ANTHROPIC_AUTH_TOKEN",
        apiKey: "ANTHROPIC_API_KEY",
        fetchModels: "Récupérer les modèles dynamiquement (/v1/models)",
        defaultModel: "Modèle par défaut (facultatif)",
        defaultModelPlaceholder: "ex. claude-opus-4-6 (vide = premier de la liste)",
        save: "Ajouter",
        saving: "Ajout…",
      },
      connection: {
        button: "Modifier la connexion",
        ...
        defaultModelUnset: "Non défini (premier de la liste)",
        save: "Enregistrer",
        saving: "Enregistrement…",
      },
      statuses: {
