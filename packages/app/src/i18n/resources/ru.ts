...
export const ru: TranslationResources = {
  ...
  schedules: {
    ...
    empty: {
      noActiveTitle: "Нет активных расписаний",
      noActiveDescription: "Расписания запускают агентов с заданной периодичностью.",
      noEndedTitle: "Нет завершённых расписаний",
    ...
    errors: {
      ...
      cronRequired: "Выберите cron-периодичность перед созданием расписания",
    },
    actions: {
    ...
    meta: {
      ...
      neverRun: "Не запускалось",
      nextRun: "Следующий запуск {{time}}",
    },
    accessibility: {
      editScheduleTitle: "Изменить расписание {{title}}",
      editHeartbeatTitle: "Изменить heartbeat {{title}}",
      scheduleActions: "Действия с расписанием",
      heartbeatActions: "Действия с heartbeat",
    },
    deleteConfirm: {
      scheduleTitle: "Удалить расписание",
      heartbeatTitle: "Удалить heartbeat",
      message: "Удалить «{{title}}»? Это действие нельзя отменить.",
    },
    cadence: {
      label: "Периодичность",
      select: "Выбрать периодичность",
      noneFound: "Периодичности не найдены",
      cronA11y: "Выражение cron",
    },
    form: {
      newTitle: "Новое расписание",
      editScheduleTitle: "Изменить расписание",
      editHeartbeatTitle: "Изменить heartbeat",
      ...
      fields: {
        ...
        projectTitle: "Выбрать проект",
        model: "Модель",
        thinking: "Thinking",
        selectThinking: "Выбрать thinking",
        noThinking: "Параметры thinking не найдены",
        thinkingTitle: "Выбрать thinking",
        mode: "Режим",
        modeDefault: "Режим по умолчанию",
        noModes: "Режимы не найдены",
        noModesForModel: "Для этой модели нет доступных режимов.",
        modeTitle: "Выбрать режим",
        archiveOnFinish: "Архивировать по завершении",
        archiveOnFinishA11y: "Архивировать по завершении",
        isolationLabel: "Изоляция",
        isolationLocal: "Локально",
        isolationWorktree: "Worktree",
        isolationSelect: "Выбрать изоляцию",
        isolationNone: "Параметры изоляции не найдены",
  ...
  workspace: {
    ...
    tabs: {
      ...
      menu: {
        ...
        copyFileRelativePath: "Скопировать относительный путь к файлу",
        copyFileFullPath: "Скопировать полный путь к файлу",
        rename: "Переименовать",
      ...
      actions: {
        ...
        openCmd: "Открыть cmd",
        openPowerShell: "Открыть PowerShell",
      ...
      toasts: {
        ...
        cannotCloseLastAgent: "Нельзя закрыть последний диалог агента",
      },
      confirmations: {
  ...
  settings: {
    ...
    layout: {
      ...
      explorerSidebar: {
        title: "Боковая панель проводника",
        autoOpen: "Открывать вместе с рабочим пространством",
        autoOpenHint:
          "Автоматически показывать боковую панель проводника при открытии рабочего пространства, если она скрыта",
        defaultView: "Вкладка при автооткрытии",
        defaultViewHint: "Вкладка проводника, на которую попадает панель при автооткрытии",
        defaultWidth: "Ширина по умолчанию",
        defaultWidthHint: "Доля ширины рабочей области до изменения размера панели",
        fileOpenMode: "Открытие файлов из боковой панели",
        fileOpenModeHint:
          "Предпросмотр повторно использует текущую вкладку, пока она не изменена; новая вкладка открывается для каждого файла",
        fileOpenModes: {
          preview: "В текущей вкладке (предпросмотр)",
          tab: "В новой вкладке",
        },
        views: {
          files: "Файлы",
    ...
    host: {
      ...
      terminalProfiles: {
        ...
        powershellPathTitle: "Путь к PowerShell",
        powershellPathHint:
          "Предпочтительный путь для встроенного действия «Открыть PowerShell». Пусто — автоматически выбирается PowerShell 7, затем Windows PowerShell.",
        powershellPathPlaceholder: "напр. C:\\Program Files\\PowerShell\\7\\pwsh.exe",
        powershellPathSave: "Сохранить",
      ...
      daemon: {
        ...
        idleAutoRestart: {
          title: "Автоперезапуск при простое",
          hint: "Автоматически перезапускает daemon после долгого времени работы без активных задач. Неактивные сеансы прерываются и восстанавливаются после перезапуска.",
          startedAtLine: "Запущен {{time}} · время работы {{uptime}}",
          idleFor: "в простое {{duration}}",
          settings: "Настройки",
          sheetTitle: "Автоперезапуск при простое",
          uptimeLabel: "Минут работы",
          uptimeHint: "Перезапуск, когда daemon проработал это время (1-10080)",
          idleLabel: "Минут без активных задач",
          idleHint: "И оставался в простое это время (1-1440)",
          invalidInteger: "Введите целое число",
          invalidRange: "Введите значение от {{min}} до {{max}}",
          save: "Сохранить",
          cancel: "Отмена",
          errorTitle: "Не удалось обновить автоперезапуск при простое",
        },
        remove: {
          title: "Удалить хост",
    ...
    providers: {
      ...
      addCustom: {
        button: "Добавить поставщика Claude вручную",
        title: "Добавить поставщика Claude",
        providerId: "ID поставщика",
        providerIdPlaceholder: "my-relay",
        providerIdInvalid:
          "ID должен начинаться со строчной буквы и содержать только строчные буквы, цифры и дефисы",
        providerIdExists: "Этот ID уже занят существующим поставщиком",
        label: "Отображаемое имя",
        labelPlaceholder: "My Relay",
        extendsLabel: "Базовый поставщик",
        extendsValue: "claude",
        baseUrl: "Конечная точка API (ANTHROPIC_BASE_URL)",
        baseUrlPlaceholder: "https://example.com (пусто = официальный API)",
        authToken: "ANTHROPIC_AUTH_TOKEN",
        apiKey: "ANTHROPIC_API_KEY",
        fetchModels: "Динамически получать модели (/v1/models)",
        defaultModel: "Модель по умолчанию (необязательно)",
        defaultModelPlaceholder: "напр. claude-opus-4-6 (пусто = первая в списке)",
        save: "Добавить",
        saving: "Добавление…",
      },
      connection: {
        ...
        defaultModelUnset: "Не задана (первая в списке)",
        save: "Сохранить",
        saving: "Сохранение…",
      },
      statuses: {
