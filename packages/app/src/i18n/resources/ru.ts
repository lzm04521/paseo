  ...
  settings: {
    ...
    appearance: {
      ...
      sidePanel: {
        ...
        autoOpen: {
          title: "Открывать боковую панель при открытии рабочего пространства",
          description:
            "Показывает панель автоматически и применяет выбранные выше панели по умолчанию; только для десктопной раскладки",
        },
        fileOpen: {
    ...
    host: {
      ...
      terminalProfiles: {
        ...
        powershellPathHint: "Предпочтительный путь для встроенного действия «Открыть PowerShell». Пусто — автоматически выбирается PowerShell 7, затем Windows PowerShell.",
