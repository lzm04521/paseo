  ...
  settings: {
    ...
    appearance: {
      ...
      sidePanel: {
        title: "Panel lateral",
        defaults: {
          label: "Abrir al mostrar el panel lateral",
          hint: "En proyectos sin Git no se abre Cambios",
          changes: "Cambios",
          fileNav: "Explorador",
        },
        width: {
          title: "Tamaño al abrirla",
        ...
        fileOpen: {
          ...
          accessibilityLabel: "Abrir archivos en: {{value}}",
          options: {
    ...
    host: {
      ...
      terminalProfiles: {
        ...
        powershellPathHint: "Ruta preferida para la acción integrada Abrir PowerShell. Vacío: se elige PowerShell 7 y luego Windows PowerShell automáticamente.",
