...
export const es: TranslationResources = {
  common: {
    ...
    errors: {
      ...
      noFileFoundAttemptedPath: "Ruta intentada: {{path}}",
  ...
  schedules: {
    ...
    empty: {
      noActiveTitle: "No hay programaciones activas",
      noActiveDescription: "Las programaciones ejecutan agentes con una cadencia.",
      noEndedTitle: "No hay programaciones finalizadas",
      seeDocs: "Ver docs",
    },
    errors: {
      unableToLoad: "No se pudieron cargar las programaciones",
      hostLoadFailed: "{{serverName}}: No se pudieron cargar las programaciones",
      cronRequired: "Elige una cadencia cron antes de crear esta programación",
    },
    actions: {
      ...
      editHeartbeat: "Editar latido",
      deleteSchedule: "Eliminar programación",
      deleteHeartbeat: "Eliminar latido",
    },
    pending: {
      pausing: "Pausando...",
      resuming: "Reanudando...",
    ...
    accessibility: {
      editScheduleTitle: "Editar programación {{title}}",
      editHeartbeatTitle: "Editar latido {{title}}",
      scheduleActions: "Acciones de programación",
      heartbeatActions: "Acciones de latido",
    },
    deleteConfirm: {
      scheduleTitle: "Eliminar programación",
      heartbeatTitle: "Eliminar latido",
      message: '¿Eliminar "{{title}}"? Esto no se puede deshacer.',
    },
    cadence: {
      label: "Cadencia",
      select: "Seleccionar cadencia",
      noneFound: "No se encontraron cadencias",
      cronA11y: "Expresión cron",
    },
    form: {
      newTitle: "Nueva programación",
      editScheduleTitle: "Editar programación",
      editHeartbeatTitle: "Editar latido",
      agentUnavailable: "Agente no disponible",
      untitledAgent: "Agente sin título",
      fields: {
        name: "Nombre",
        nameA11y: "Nombre de la programación",
        namePlaceholder: "Opcional",
        prompt: "Prompt",
        promptA11y: "Prompt",
        promptPlaceholder: "¿Qué debe hacer el agente en cada ejecución?",
        maxRuns: "Ejecuciones máx.",
        maxRunsA11y: "Ejecuciones máx.",
        ...
        model: "Modelo",
        thinking: "Thinking",
        selectThinking: "Seleccionar thinking",
        noThinking: "No se encontraron opciones de thinking",
        thinkingTitle: "Seleccionar thinking",
        mode: "Modo",
        modeDefault: "Modo predet.",
        ...
        archiveOnFinishA11y: "Archivar al finalizar",
        isolationLabel: "Aislamiento",
        isolationLocal: "Local",
        isolationWorktree: "Worktree",
        isolationSelect: "Seleccionar aislamiento",
        isolationNone: "No se encontraron opciones de aislamiento",
        isolationTitle: "Aislamiento",
      },
    },
  },
  message: {
  ...
  workspace: {
    ...
    tabs: {
      ...
      toasts: {
        ...
        cannotCloseLastAgent: "No se puede cerrar la última conversación del agente",
      },
      confirmations: {
  ...
  settings: {
    ...
    layout: {
      ...
      explorerSidebar: {
        ...
        defaultView: "Pestaña al abrir automáticamente",
        defaultViewHint:
          "Pestaña del explorador en la que se sitúa el panel al abrirse automáticamente",
    ...
    host: {
      ...
      terminalProfiles: {
        ...
        powershellPathTitle: "Ruta de PowerShell",
        powershellPathHint:
          "Ruta preferida para la acción integrada Abrir PowerShell. Vacío: se elige PowerShell 7 y luego Windows PowerShell automáticamente.",
        powershellPathPlaceholder: "p. ej. C:\\Program Files\\PowerShell\\7\\pwsh.exe",
        powershellPathSave: "Guardar",
      ...
      daemon: {
        ...
        idleAutoRestart: {
          ...
          uptimeHint: "Reiniciar cuando el daemon lleve funcionando este tiempo (1-10080)",
          idleLabel: "Minutos sin tareas activas",
          idleHint: "Y haya estado inactivo este tiempo (1-1440)",
          invalidInteger: "Introduce un número entero",
          invalidRange: "Introduce un valor entre {{min}} y {{max}}",
          save: "Guardar",
          cancel: "Cancelar",
          errorTitle: "No se pudo actualizar el reinicio automático por inactividad",
        },
        remove: {
          title: "Eliminar host",
    ...
    providers: {
      ...
      addCustom: {
        button: "Añadir proveedor Claude manualmente",
        title: "Añadir proveedor Claude",
        providerId: "ID del proveedor",
        providerIdPlaceholder: "my-relay",
        providerIdInvalid:
          "El ID debe comenzar con una letra minúscula y contener solo letras minúsculas, dígitos y guiones",
        providerIdExists: "Este ID ya lo usa un proveedor existente",
        label: "Nombre visible",
        labelPlaceholder: "My Relay",
        extendsLabel: "Proveedor base",
        extendsValue: "claude",
        baseUrl: "Punto de conexión (ANTHROPIC_BASE_URL)",
        baseUrlPlaceholder: "https://example.com (vacío = API oficial)",
        authToken: "ANTHROPIC_AUTH_TOKEN",
        apiKey: "ANTHROPIC_API_KEY",
        fetchModels: "Obtener modelos dinámicamente (/v1/models)",
        defaultModel: "Modelo predeterminado (opcional)",
        defaultModelPlaceholder: "p. ej., claude-opus-4-6 (vacío = el primero de la lista)",
        save: "Añadir",
        saving: "Añadiendo…",
      },
      connection: {
        button: "Editar conexión",
        ...
        defaultModelUnset: "Sin establecer (el primero de la lista)",
        save: "Guardar",
        saving: "Guardando…",
      },
      statuses: {
