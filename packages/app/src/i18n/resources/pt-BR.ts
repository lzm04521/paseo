...
export const ptBR: TranslationResources = {
  ...
  schedules: {
    ...
    empty: {
      noActiveTitle: "Nenhum agendamento ativo",
      noActiveDescription: "Agendamentos executam agentes em uma cadência.",
      noEndedTitle: "Nenhum agendamento encerrado",
      seeDocs: "Ver docs",
    },
    errors: {
      ...
      cronRequired: "Escolha uma cadência cron antes de criar este agendamento",
    },
    actions: {
      ...
      deleteHeartbeat: "Excluir heartbeat",
    },
    pending: {
      pausing: "Pausando...",
      resuming: "Retomando...",
    ...
    accessibility: {
      editScheduleTitle: "Editar agendamento {{title}}",
      editHeartbeatTitle: "Editar heartbeat {{title}}",
      scheduleActions: "Ações do agendamento",
      heartbeatActions: "Ações do heartbeat",
    },
    deleteConfirm: {
      scheduleTitle: "Excluir agendamento",
      heartbeatTitle: "Excluir heartbeat",
      message: 'Excluir "{{title}}"? Isso não pode ser desfeito.',
    },
    cadence: {
      label: "Cadência",
      select: "Selecionar cadência",
      noneFound: "Nenhuma cadência encontrada",
      cronA11y: "Expressão cron",
    },
    form: {
      newTitle: "Novo agendamento",
      editScheduleTitle: "Editar agendamento",
      editHeartbeatTitle: "Editar heartbeat",
      ...
      fields: {
        ...
        maxRuns: "Execuções máx.",
        maxRunsA11y: "Execuções máx.",
        ...
        model: "Modelo",
        thinking: "Thinking",
        selectThinking: "Selecionar thinking",
        noThinking: "Nenhuma opção de thinking encontrada",
        thinkingTitle: "Selecionar thinking",
        mode: "Modo",
        modeDefault: "Modo padrão",
        noModes: "Nenhum modo encontrado",
        noModesForModel: "Nenhum modo disponível para este modelo.",
        modeTitle: "Selecionar modo",
        archiveOnFinish: "Arquivar ao concluir",
        archiveOnFinishA11y: "Arquivar ao concluir",
        isolationLabel: "Isolamento",
        isolationLocal: "Local",
        isolationWorktree: "Worktree",
        isolationSelect: "Selecionar isolamento",
        isolationNone: "Nenhuma opção de isolamento encontrada",
        isolationTitle: "Isolamento",
      },
    },
  },
  message: {
  ...
  workspace: {
    ...
    tabs: {
      ...
      toasts: {
        ...
        cannotCloseLastAgent: "Não é possível fechar a última conversa do agente",
      },
      confirmations: {
  ...
  settings: {
    ...
    host: {
      ...
      terminalProfiles: {
        ...
        powershellPathTitle: "Caminho do PowerShell",
        powershellPathHint:
          "Caminho preferido para a ação integrada Abrir PowerShell. Vazio: escolhe automaticamente PowerShell 7 e depois Windows PowerShell.",
        powershellPathPlaceholder: "ex.: C:\\Program Files\\PowerShell\\7\\pwsh.exe",
        powershellPathSave: "Salvar",
      ...
      daemon: {
        ...
        idleAutoRestart: {
          ...
          uptimeHint: "Reiniciar quando o daemon estiver em execução por este tempo (1-10080)",
          idleLabel: "Minutos sem tarefas em execução",
          idleHint: "E tiver ficado ocioso por este tempo (1-1440)",
          invalidInteger: "Digite um número inteiro",
          invalidRange: "Digite um valor entre {{min}} e {{max}}",
          save: "Salvar",
          cancel: "Cancelar",
          errorTitle: "Não foi possível atualizar o reinício automático por inatividade",
        },
        remove: {
          title: "Remover host",
    ...
    providers: {
      ...
      addCustom: {
        button: "Adicionar provedor Claude manualmente",
        title: "Adicionar provedor Claude",
        providerId: "ID do provedor",
        providerIdPlaceholder: "my-relay",
        providerIdInvalid:
          "O ID deve começar com uma letra minúscula e conter apenas minúsculas, dígitos e hífens",
        providerIdExists: "Este ID já é usado por um provedor existente",
        label: "Nome de exibição",
        labelPlaceholder: "My Relay",
        extendsLabel: "Provedor base",
        extendsValue: "claude",
        baseUrl: "Endpoint de API (ANTHROPIC_BASE_URL)",
        baseUrlPlaceholder: "https://example.com (vazio = API oficial)",
        authToken: "ANTHROPIC_AUTH_TOKEN",
        apiKey: "ANTHROPIC_API_KEY",
        fetchModels: "Buscar modelos dinamicamente (/v1/models)",
        defaultModel: "Modelo padrão (opcional)",
        defaultModelPlaceholder: "ex.: claude-opus-4-6 (vazio = primeiro da lista)",
        save: "Adicionar",
        saving: "Adicionando…",
      },
      connection: {
        button: "Editar conexão",
        ...
        defaultModelUnset: "Não definido (primeiro da lista)",
        save: "Salvar",
        saving: "Salvando…",
      },
      statuses: {
