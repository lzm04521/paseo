  ...
  settings: {
    ...
    appearance: {
      ...
      sidePanel: {
        ...
        autoOpen: {
          title: "فتح اللوحة الجانبية عند فتح مساحة عمل",
          description:
            "تُظهر اللوحة تلقائيًا وتطبق اللوحات الافتراضية المختارة أعلاه؛ لتخطيطات سطح المكتب فقط",
        },
        fileOpen: {
    ...
    host: {
      ...
      terminalProfiles: {
        ...
        powershellPathHint: "المسار المفضل لإجراء فتح PowerShell المدمج. اتركه فارغًا لاختيار PowerShell 7 ثم Windows PowerShell تلقائيًا.",
