...
export const ar: TranslationResources = {
  ...
  schedules: {
    ...
    empty: {
      noActiveTitle: "لا توجد جدولة نشطة",
      noActiveDescription: "تقوم الجدولة بتشغيل الوكلاء بشكل دوري.",
      noEndedTitle: "لا توجد جدولة منتهية",
      seeDocs: "عرض الوثائق",
    },
    errors: {
      unableToLoad: "تعذّر تحميل الجدولة",
      hostLoadFailed: "{{serverName}}: تعذّر تحميل الجدولة",
      cronRequired: "اختر تكرار cron قبل إنشاء هذا الجدول",
    },
    actions: {
      new: "جدول جديد",
      ...
      create: "إنشاء جدول",
      delete: "حذف",
      pauseSchedule: "إيقاف الجدول مؤقتًا",
      resumeSchedule: "استئناف الجدول",
      runNow: "تشغيل الآن",
      editSchedule: "تحرير الجدول",
      editHeartbeat: "تحرير النبضة",
      deleteSchedule: "حذف الجدول",
      deleteHeartbeat: "حذف النبضة",
    },
    pending: {
    ...
    meta: {
      ...
      neverRun: "لم يُشغّل مطلقًا",
      nextRun: "التشغيل التالي {{time}}",
    },
    accessibility: {
      editScheduleTitle: "تحرير الجدول {{title}}",
      editHeartbeatTitle: "تحرير النبضة {{title}}",
      scheduleActions: "إجراءات الجدول",
      heartbeatActions: "إجراءات النبضة",
    },
    deleteConfirm: {
      scheduleTitle: "حذف الجدول",
      heartbeatTitle: "حذف النبضة",
      message: 'حذف "{{title}}"؟ لا يمكن التراجع عن هذا الإجراء.',
    },
    cadence: {
      label: "التكرار",
      select: "اختر التكرار",
      noneFound: "لم يُعثر على تكرارات",
      cronA11y: "تعبير cron",
    },
    form: {
      newTitle: "جدول جديد",
      editScheduleTitle: "تحرير الجدول",
      editHeartbeatTitle: "تحرير النبضة",
      ...
      fields: {
        ...
        prompt: "الموجّه",
        promptA11y: "الموجّه",
        promptPlaceholder: "ما الذي يجب أن يفعله الوكيل في كل تشغيل؟",
        maxRuns: "أقصى تشغيلات",
        maxRunsA11y: "أقصى تشغيلات",
        maxRunsPlaceholder: "غير محدود",
        target: "الهدف",
        host: "المضيف",
        selectHost: "اختر المضيف",
        noHosts: "لم يُعثر على مضيفين",
        hostTitle: "المضيف",
        project: "المشروع",
        selectProject: "اختر المشروع",
        noProjects: "لم يُعثر على مشاريع",
        chooseHostFirst: "اختر مضيفًا أولاً.",
        searchProjects: "ابحث في المشاريع...",
        projectTitle: "اختر المشروع",
        model: "النموذج",
        thinking: "Thinking",
        selectThinking: "اختر thinking",
        noThinking: "لم يُعثر على خيارات thinking",
        thinkingTitle: "اختر thinking",
        mode: "الوضع",
        modeDefault: "الوضع الافتراضي",
        noModes: "لم يُعثر على أوضاع",
        noModesForModel: "لا توجد أوضاع متاحة لهذا النموذج.",
        modeTitle: "اختر الوضع",
        archiveOnFinish: "أرشفة عند الانتهاء",
        archiveOnFinishA11y: "أرشفة عند الانتهاء",
        isolationLabel: "العزل",
        isolationLocal: "محلي",
        isolationWorktree: "Worktree",
        isolationSelect: "اختر العزل",
        isolationNone: "لم يُعثر على خيارات عزل",
        isolationTitle: "العزل",
      },
    },
  },
  message: {
  ...
  workspace: {
    ...
    tabs: {
      ...
      toasts: {
        ...
        cannotCloseLastAgent: "تعذر إغلاق آخر محادثة للوكيل",
      },
      confirmations: {
  ...
  sidebar: {
    ...
    project: {
      actions: {
        ...
        openInVSCode: "فتح في VS Code",
        openInVSCodeFailed: "تعذر فتح VS Code",
  ...
  settings: {
    ...
    host: {
      ...
      terminalProfiles: {
        ...
        powershellPathTitle: "مسار PowerShell",
        powershellPathHint:
          "المسار المفضل لإجراء فتح PowerShell المدمج. اتركه فارغًا لاختيار PowerShell 7 ثم Windows PowerShell تلقائيًا.",
        powershellPathPlaceholder: "مثال: C:\\Program Files\\PowerShell\\7\\pwsh.exe",
        powershellPathSave: "حفظ",
      ...
      daemon: {
        ...
        idleAutoRestart: {
          ...
          uptimeHint: "إعادة التشغيل بعد تشغيل daemon لهذه المدة (1-10080)",
          idleLabel: "دقائق دون مهام قيد التنفيذ",
          idleHint: "وبقائه خاملًا لهذه المدة (1-1440)",
          invalidInteger: "أدخل رقمًا صحيحًا",
          invalidRange: "أدخل قيمة بين {{min}} و{{max}}",
          save: "حفظ",
          cancel: "إلغاء",
          errorTitle: "تعذّر تحديث إعادة التشغيل التلقائي عند الخمول",
        },
        remove: {
          title: "إزالة المضيف",
    ...
    providers: {
      ...
      addCustom: {
        button: "إضافة مزود Claude يدويًا",
        title: "إضافة مزود Claude",
        providerId: "معرّف المزود",
        providerIdPlaceholder: "my-relay",
        providerIdInvalid: "يجب أن يبدأ المعرف بحرف صغير ويحتوي على أحرف صغيرة وأرقام وشرطات فقط",
        providerIdExists: "هذا المعرف مستخدم بالفعل بواسطة مزود موجود",
        label: "الاسم المعروض",
        labelPlaceholder: "My Relay",
        extendsLabel: "المزود الأساسي",
        extendsValue: "claude",
        baseUrl: "نقطة النهاية (ANTHROPIC_BASE_URL)",
        baseUrlPlaceholder: "https://example.com (فارغ = API الرسمي)",
        authToken: "ANTHROPIC_AUTH_TOKEN",
        apiKey: "ANTHROPIC_API_KEY",
        fetchModels: "جلب النماذج ديناميكيًا (/v1/models)",
        defaultModel: "النموذج الافتراضي (اختياري)",
        defaultModelPlaceholder: "مثال: claude-opus-4-6 (فارغ = أول القائمة)",
        save: "إضافة",
        saving: "جارٍ الإضافة…",
      },
      connection: {
        button: "تعديل الاتصال",
        title: "تعديل الاتصال",
        label: "الاسم المعروض",
        baseUrl: "نقطة النهاية (ANTHROPIC_BASE_URL)",
        baseUrlPlaceholder: "https://example.com (فارغ = API الرسمي)",
        ...
        defaultModelUnset: "غير محدد (أول القائمة)",
        save: "حفظ",
        saving: "جارٍ الحفظ…",
      },
      statuses: {
