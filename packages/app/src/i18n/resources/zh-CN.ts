...
export const zhCN: TranslationResources = {
  ...
  schedules: {
    ...
    empty: {
      noActiveTitle: "没有运行中的计划",
      noActiveDescription: "计划会按固定频率运行 Agent。",
      noEndedTitle: "没有已结束的计划",
      seeDocs: "查看文档",
    },
    errors: {
      unableToLoad: "无法加载计划",
      hostLoadFailed: "{{serverName}}：无法加载计划",
      cronRequired: "创建此计划前请先选择一个 cron 频率",
    },
    actions: {
      new: "新建计划",
      retry: "重试",
    ...
    accessibility: {
      editScheduleTitle: "编辑计划 {{title}}",
      editHeartbeatTitle: "编辑心跳 {{title}}",
      scheduleActions: "计划操作",
    ...
    form: {
      ...
      fields: {
        ...
        prompt: "提示词",
        promptA11y: "提示词",
        promptPlaceholder: "Agent 每次运行要做什么？",
        maxRuns: "最大运行次数",
        maxRunsA11y: "最大运行次数",
        ...
        selectProject: "选择项目",
        noProjects: "未找到项目",
        chooseHostFirst: "请先选择一个 Host。",
        searchProjects: "搜索项目...",
        projectTitle: "选择项目",
        model: "模型",
        thinking: "思考",
        selectThinking: "选择 thinking",
        noThinking: "未找到 thinking 选项",
        thinkingTitle: "选择 thinking",
        mode: "模式",
        modeDefault: "默认模式",
        noModes: "未找到模式",
        ...
        archiveOnFinishA11y: "完成后归档",
        isolationLabel: "隔离",
        isolationLocal: "本地",
        isolationWorktree: "工作树",
        isolationSelect: "选择隔离方式",
        isolationNone: "未找到隔离选项",
        isolationTitle: "隔离",
      },
    },
  },
  ...
  workspace: {
    ...
    tabs: {
      ...
      menu: {
        ...
        copyFileRelativePath: "复制文件相对路径",
        copyFileFullPath: "复制文件完整路径",
        rename: "重命名",
        closeAbove: "关闭上方标签",
        closeBelow: "关闭下方标签",
        closeLeft: "关闭左侧标签",
  ...
  newWorkspace: {
    ...
    launch: {
      ...
      manageProfiles: "管理配置",
      submit: "启动",
      promptPlaceholder: "提示 {{name}}",
      commandPlaceholder: "运行命令，或留空以使用空白终端",
    },
  },
  desktop: {
    windowControls: {
    ...
    daemon: {
      lifecycle: {
        owned: "由此桌面会话启动",
        attached: "已附加到现有 daemon",
        ownedMessage: "此 daemon 由当前桌面会话启动。",
        attachedMessage: "此 daemon 不是由当前桌面会话启动的。",
        stopTitle: "停止本地 daemon？",
        stopMessage:
          "{{ownership}}\nHome：{{home}}\nSupervisor PID：{{pid}}\n运行中的 agent 工作将被中断。",
        stop: "停止 daemon",
        stopping: "正在停止…",
        stopFailed: "无法停止 daemon",
        pauseAttached: "暂停自动 daemon 管理？已附加的 daemon 将继续运行。",
        pause: "暂停管理",
        workerUpdated: "Worker 已更新到 {{version}}",
        supervisorRefresh: "运行中的 supervisor 仍保留其原始代码。启动器需停止并重新启动它才能刷新 supervisor。",
      },
      title: "Daemon",
      status: {
        title: "状态",
  ...
  settings: {
    ...
    layout: {
      openInSidePane: {
        ...
        sources: {
          explorerFiles: {
            label: "在资源管理器中选择文件",
            description: "在工作区旁边打开资源管理器侧栏中选择的文件",
          },
          diffs: {
            label: "打开差异",
            description: "在当前工作旁边打开资源管理器和对话中的差异",
          },
          chatFiles: {
            label: "从对话打开文件",
            description: "在对话旁边打开文件链接和工具调用文件",
          },
          diffFiles: {
            label: "从更改打开文件",
            description: "在差异旁边打开从中选择的源文件",
          },
          subagents: {
            label: "打开子代理",
            description: "在父代理旁边打开子代理",
          },
          pullRequests: {
            label: "从更改打开拉取请求",
            description: "在更改旁边打开拉取请求详情",
          },
        },
      },
      explorerSidebar: {
    ...
    diagnostics: {
      ...
      app: {
        title: "应用诊断",
        rowTitle: "应用诊断",
        rowHint: "收集连接、守护进程、提供商、桌面端和日志详情",
        run: "运行",
        running: "正在运行诊断…",
        copyLabel: "诊断",
    ...
    host: {
      ...
      skills: {
        ...
        unsupported: "更新此 Host 以管理编排 skills",
      ...
      metadata: {
        defaults: {
          title: "元数据生成默认值",
          hint: "自动生成的标题、分支名、提交信息和 PR 的全局默认提示。项目 paseo.json 优先于此。",
          edit: "编辑",
          sheetTitle: "元数据生成默认值",
          reset: "重置",
          save: "保存",
      ...
      terminalProfiles: {
        unavailable: "连接到该主机以管理终端配置",
        sectionTitle: "终端配置",
        powershellPathTitle: "PowerShell 路径",
        powershellPathHint:
          "「打开PowerShell」优先使用此路径；留空则自动选择 PowerShell 7，其次系统 Windows PowerShell。",
        powershellPathPlaceholder: "C:\\Program Files\\PowerShell\\7\\pwsh.exe",
        powershellPathSave: "保存",
        editProfile: "编辑配置",
        ...
        moveDown: "下移",
        save: "保存",
        emptyState: "暂无配置。添加一个即可用特定命令启动终端。",
      },
      agentProfiles: {
      ...
      daemon: {
        ...
        update: {
          ...
          confirmMessage: "这将把守护进程更新到最新版本并重启。正在运行的 Agent 会被短暂中断。",
          updating: "更新中…",
          ...
          unableToReconnectTitle: "无法重新连接",
          unableToReconnectMessage: "{{name}} 更新后未恢复在线。请确认守护进程已重启。",
          unavailableTitle: "主机不可用",
          unavailableMessage: "该主机未连接。请等待其恢复在线后再更新。",
          offlineTitle: "主机离线",
          offlineMessage: "该主机离线。请等待其恢复在线后再更新。",
          requestFailedTitle: "更新失败",
          requestFailedMessage: "更新守护进程失败：{{error}}",
        ...
        idleAutoRestart: {
          ...
          sheetTitle: "空闲自动重启",
          uptimeLabel: "运行时长（分钟）",
          uptimeHint: "daemon 运行超过该时长后可触发（1-10080）",
          idleLabel: "连续空闲（分钟）",
          idleHint: "且连续无执行中任务达到该时长后触发（1-1440）",
          invalidInteger: "请输入整数",
          invalidRange: "请输入 {{min}} 到 {{max}} 之间的值",
          save: "保存",
          cancel: "取消",
          errorTitle: "无法更新空闲自动重启",
        },
        remove: {
          title: "移除 Host",
    ...
    providers: {
      ...
      remove: {
        ...
        confirmMessage: "这会从 config.json 删除该提供商条目，无法撤销。",
        confirm: "移除",
        errorTitle: "无法移除提供商",
      },
      addCustom: {
        button: "手动添加 Claude 供应商",
        title: "添加 Claude 供应商",
        providerId: "供应商 ID",
        providerIdPlaceholder: "my-relay",
        providerIdInvalid: "ID 必须小写字母开头，仅含小写字母、数字、连字符",
        providerIdExists: "该 ID 已被现有供应商使用",
        label: "显示名称",
        labelPlaceholder: "My Relay",
        extendsLabel: "基础供应商",
        extendsValue: "claude",
        baseUrl: "API 端点（ANTHROPIC_BASE_URL）",
        baseUrlPlaceholder: "https://example.com（留空使用官方地址）",
        authToken: "ANTHROPIC_AUTH_TOKEN",
        apiKey: "ANTHROPIC_API_KEY",
        fetchModels: "动态拉取模型列表（/v1/models）",
        save: "添加",
        saving: "添加中…",
      },
      connection: {
    ...
    project: {
      ...
      metadata: {
        ...
        titleGenerationPlaceholder: "生成简短、清晰的任务标题，并遵循项目的术语和语言约定",
        branchName: "分支名称",
