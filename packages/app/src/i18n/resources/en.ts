  ...
  settings: {
    ...
    host: {
      ...
      terminalProfiles: {
        ...
        powershellPathTitle: "PowerShell path",
        powershellPathHint:
          "Preferred executable for the built-in Open PowerShell action. Leave empty to auto-pick PowerShell 7, then Windows PowerShell.",
        powershellPathPlaceholder: "e.g. C:\\Program Files\\PowerShell\\7\\pwsh.exe",
        powershellPathSave: "Save",
      ...
      daemon: {
        ...
        idleAutoRestart: {
          ...
          uptimeHint: "Restart once the daemon has run this long (1-10080)",
          idleLabel: "Minutes without running tasks",
          idleHint: "And has stayed idle this long (1-1440)",
          invalidInteger: "Enter a whole number",
          invalidRange: "Enter a value between {{min}} and {{max}}",
          save: "Save",
          cancel: "Cancel",
          errorTitle: "Unable to update idle auto-restart",
        },
        remove: {
          title: "Remove host",
    ...
    providers: {
      ...
      addCustom: {
        button: "Add Claude provider manually",
        ...
        providerIdExists: "This ID is already used by an existing provider",
        label: "Display name",
        labelPlaceholder: "My Relay",
        extendsLabel: "Base provider",
        extendsValue: "claude",
        baseUrl: "API endpoint (ANTHROPIC_BASE_URL)",
        baseUrlPlaceholder: "https://example.com (empty = official API)",
        authToken: "ANTHROPIC_AUTH_TOKEN",
        apiKey: "ANTHROPIC_API_KEY",
        fetchModels: "Fetch models dynamically (/v1/models)",
        defaultModel: "Default model (optional)",
        defaultModelPlaceholder: "e.g. claude-opus-4-6 (empty = first listed)",
        save: "Add",
        saving: "Adding…",
      },
      connection: {
        ...
        defaultModelUnset: "Not set (first listed)",
        save: "Save",
        saving: "Saving…",
      },
      statuses: {
